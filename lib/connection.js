...
function Connection (opts) {
  ...
  this.base = {
    ...
    preRequest: opts.preRequest || false,
    postRequest: opts.postRequest || false
  };
...
Connection.prototype.go = function (name, params, callback) {
  ...
  var postRequest = this.base.postRequest;

  if (this.base.preRequest) {
    this.base.preRequest(data);
  }
